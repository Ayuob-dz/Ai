                ...
                <div class="row mt-4">
                    <div class="col-md-4">
                        <div class="stat-card">
                            ...
                            <a href="deposit.php" class="btn btn-sm btn-primary">شحن</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="stat-card">
                    ...
                    <div class="col-md-4">
                        <div class="stat-card">
                            <h5>آخر طلب</h5>
                            <?php
                            $last = $conn->query("SELECT created_at FROM orders WHERE user_id = {$user['id']} ORDER BY created_at DESC LIMIT 1")->fetch_assoc();
                            ?>
                            <h3><?php echo $last ? format_date($last['created_at']) : 'لا يوجد'; ?></h3>
                        </div>
                    </div>
                </div>
            </div>
